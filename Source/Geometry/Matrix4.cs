namespace HaighFramework
{
    public struct Matrix4
    {
        ...
        {
            Matrix4 scaleMat = Matrix4.CreateScale(scaleX, scaleY, scaleZ);
        ...
        {
            Matrix4 translate1 = Matrix4.CreateTranslation(x, y, 0);
            Matrix4 scale = Matrix4.CreateScale(scaleX, scaleY, 0);
            Matrix4 translate2 = Matrix4.CreateTranslation(-x, -y, 0);

            Matrix4 result = Matrix4.Multiply(ref mat, ref translate1);
            result = Matrix4.Multiply(ref result, ref scale);
            result = Matrix4.Multiply(ref result, ref translate2);
